/*This is my version of the existing collision response animator. Like with the fps camera animator, I found its 
original functionality not quite suitable for my needs. However, I wanted all of my work to be included in the solution,
so modifiying the engine was not how I wanted to approach it. Instead I opted to copy and modify the existing code.*/
...
namespace scene
{
	...
	*/
	class MyCollisionAnimator : public ISceneNodeAnimatorCollisionResponse
	{
	public:

		//! constructor
		MyCollisionAnimator(ISceneManager* scenemanager,
